...
bool testInsertNode(){
    ...
    exampleList.print(false);
    exampleList.insertNode(390, 6);
    cout << "Forward Print Expected Output: 310 315 320 330 335 340 390" << endl;
    exampleList.print(true);
    exampleList.destroyList();
    return true;
}
...
void testCount() {
    ...
    cout << "Testing Variable Count. . ." << endl;

    cout << "Is list empty? " << (myList.isEmptyList() ? "Yes" : "No") << endl;
    cout << "Predicted Output: Is list empty? Yes" << endl;


    cout << "Count: " << myList.length() << endl;
    cout << "Predicted Output: Count: 0" << endl;

    myList.insertFirst(10);
    cout << "Count: " << myList.length() << endl;
    cout << "Predicted Output: Count: 1" << endl;

    myList.insertFirst(20);
    myList.insertFirst(30);
    cout << "Count: " << myList.length() << endl;
    cout << "Predicted Output: Count: 3" << endl;

    myList.insertLast(40);
    myList.insertLast(50);
    cout << "Count: " << myList.length() << endl;
    cout << "Predicted Output: Count: 5" << endl;


    myList.insertNode(15, 1);
    myList.insertNode(35, 3);
    myList.insertNode(45, 5);
    cout << "Count: " << myList.length() << endl;
    cout << "Predicted Output: Count: 8" << endl;
    ...
    cout << "Count: " << myList.length() << endl;
    cout << "Predicted Output: Count: 4" << endl;
}
...
int main()
{
    ...
    testErrorMessages();
    cout << "Error Tests Finished";
    cout << "\n\n";

    testTypeSupport();
    cout << "Type Support Tests Finished";
    cout << "\n\n";

    testCount();
    cout << "Count Tests Finished";
    cout << "\n\n";
